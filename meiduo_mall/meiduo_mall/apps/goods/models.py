...
class SKU(BaseModel):
    ...
    # goods = models.ForeignKey(Goods, on_delete=models.CASCADE, verbose_name='商品')
    goods = models.ForeignKey(Goods, on_delete=models.SET_NULL, verbose_name='商品', blank=True, null=True)
    # category = models.ForeignKey(GoodsCategory, on_delete=models.PROTECT, verbose_name='从属类别')
    category = models.ForeignKey(GoodsCategory, on_delete=models.SET_NULL, verbose_name='从属类别', blank=True, null=True)
